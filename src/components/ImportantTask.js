...
function ImportantTask() {
    ...
    const fetchImportantTaskP = () => {
        try {
            if (user) {
                const taskColRef = query(collection(db, 'nirtodoapp' + user.uid), where("taskimportant", "==", true), where("taskcompleted", "==", false))
                        ...
                        <div className="col-lg-8 col-md-6 col-sm-6 col-12">
                            <div className="nir-main-content">
                                <div className="nir-main-header">
                                    <h4><i className="far fa-lightbulb-on"></i> Important Task</h4>
                                </div>
                                            ...
                                            <div id="accordion">
                                                ...
                                                <ul className="nav nav-tabs mb-3 " role="tablist">
                                                    <li className="nav-item">
                                                        <a className="nav-link active" data-toggle="pill" href="#important">Important Task <span className="badge badge-primary badge-pill">{pendingCount}</span></a>
                                                    </li>
